  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="index.php?p=blog">Blog</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="index.php?p=contact">Contact</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="index.php?p=about">About us</a>
        </li>
        
        <?php  if(!empty($_SESSION['username'])){ //utilizador autenticado?>
          <li class="nav-item">
          ...
          <?php if(!empty($_SESSION['type']) && $_SESSION['type']==1){ //utilizador administrador?>
            <li class="nav-item">
              <a class="nav-link" href="index.php?p=administration">Admnistration</a>
            </li>
          <?php } ?>
          <li class="nav-item">
